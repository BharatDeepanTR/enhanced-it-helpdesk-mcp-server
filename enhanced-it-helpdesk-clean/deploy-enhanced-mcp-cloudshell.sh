...
# Deploy Enhanced TR IT Helpdesk with Real Service Desk URLs
# Features: Source Attribution, Teams Chat, SharePoint Integration
#################################################

set -e

echo "🚀 Enhanced Thomson Reuters IT Helpdesk MCP Server v2.0 Deployment"
echo "=================================================================="
echo "Target: a208194-it-helpdesk-enhanced-mcp-server"
echo "Gateway: a208194-askjulius-agentcore-gateway-mcp-iam-fvro4phd59"
echo "Version: Enhanced v2.0 with Real TR Service Desk Integration"
echo ""
echo "✨ Features Being Deployed:"
echo "  - Real Service Desk SharePoint: https://trten.sharepoint.com/sites/TR_Service_Desk_Test"
echo "  - Teams Live Chat Support with direct URLs"
echo "  - Official ServiceNow Portal: https://thomsonreuters.service-now.com" 
echo "  - Authentic Password Reset: https://pwreset.thomsonreuters.com"
echo "  - Source Attribution (Internal TR vs AI-Generated responses)"
echo "  - Claude AI Enhancement for complex queries"
echo ""
...
echo "📝 Step 2: Creating enhanced Thomson Reuters IT Helpdesk Lambda function..."
echo "📋 Features: Real Service Desk URLs, Source Attribution, Claude AI Enhancement"

# Copy our current enhanced TR IT helpdesk code
if [ -f "tr_it_helpdesk_lambda.py" ]; then
    echo "✅ Using existing tr_it_helpdesk_lambda.py"
    cp tr_it_helpdesk_lambda.py lambda_function.py
else
    echo "📝 Creating enhanced TR IT Helpdesk with real Service Desk integration..."
    cat > lambda_function.py << 'ENHANCED_EOF'
#!/usr/bin/env python3
"""
...
ENHANCED_EOF
    ...
    # If tr_it_helpdesk_lambda.py exists, we copied it above
    echo "✅ Enhanced Thomson Reuters IT Helpdesk Lambda function ready"
fi

echo "✅ Enhanced Thomson Reuters IT Helpdesk Lambda function ready"
echo "📋 Key Features Included:"
echo "  ✅ Real Thomson Reuters Service Desk SharePoint site"
echo "  ✅ Teams live chat support with direct URLs"
echo "  ✅ Official ServiceNow portal integration"
echo "  ✅ Authentic TR password reset procedures"
echo "  ✅ Source attribution for transparency"
echo "  ✅ Claude AI enhancement for complex queries"
echo "  ✅ 8 IT support services with real TR resources"
